	...
	<article class="col-12 bg-white rounded shadow my-1 py-4">
		...
		<form class="mx-auto w-75" action="" method="post" id="form-atualizar" name="form-atualizar">
			...
			<div class="mb-3">
				...
				<select  class="form-select" name="tipo" id="tipo" value="<?= $dados['tipo']?>" required>
					<option value=""></option>
					
					<option
					<?php if($dados['tipo'] == 'editor') echo " selected "?> value="editor">Editor</option>
					
					<option
					<?php if($dados['tipo'] == 'admin') echo " selected "?> value="admin">Administrador</option>
				</select>
			</div>
